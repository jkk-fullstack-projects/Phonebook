...
export const buttonStyles = {
    deleteButton: "py-1 px-3 rounded text-xs bg-red-400 hover:bg-red-300 text-white",
    showButton: "py-1 px-3 rounded bg-blue-500 hover:bg-blue-700 text-white",
};

export const inputStyles = {
    inputField: "shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline",
    searchFormInput: "mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
};
